# python-telegram-bot + FlowCastle example

A complete, runnable [python-telegram-bot 21/22](https://python-telegram-bot.org) bot with FlowCastle attached. Copy this folder and you have a
...
| `/human` | opens the chat in FlowCastle Live Chat for a teammate | `request_live_agent(...)` |
| any text | echo | — |
